...
#define BOARD_COMM_EXTI_ISR_PRE_PRI 3
#define BOARD_COMM_EXTI_ISR_SUB_PRI 3

//#define GYRO_SPI_ISR_PRE_PRI 3
//#define GYRO_SPI_ISR_SUB_PRI 3
#define GYRO_SPI_DMA_RX_PRE_PRI 1
#define GYRO_SPI_DMA_RX_SUB_PRI 1
//#define GYRO_SPI_DMA_TX_PRE_PRI 2
//#define GYRO_SPI_DMA_TX_SUB_PRI 2

#define GYRO_EXTI_ISR_PRE_PRI 1
